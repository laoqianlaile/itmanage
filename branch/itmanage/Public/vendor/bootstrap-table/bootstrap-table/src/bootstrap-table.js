...
(function ($) {
    ...
    //白景琦增加，解决IE8下报错‘JSON未定义’的问题
    if (typeof(JSON) == 'undefined') {
        document.write("<script src='../../../Public/js/json2.js'></script>");
    }
    // TOOLS DEFINITION
    // ======================
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            ...
            $keepOpen.find('input').off('click').on('click', function () {
                var $this = $(this);
                //2019-04-17 白景琦增加 用cookie记录各个页面隐藏列
                if(typeof($_hide) == 'object'){
                    if($this.is(':checked')){
                        $_hide.removeHideColumn($(this).attr('data-field'));
                    }else{
                        $_hide.recordHideColumn($(this).attr('data-field'));
                    }
                }
