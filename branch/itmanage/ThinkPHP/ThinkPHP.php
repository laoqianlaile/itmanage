...
defined('WSDL_PATH')   or define('WSDL_PATH', 'WSDL');  //2018-6-1白景琦增加，WSDL生成文件路径
defined('SERVER_MODULE')   or define('SERVER_MODULE', 'Server'); //2018-6-1白景琦增加，webservice发布模块
defined('SERVER_IMPLEMENT_NAME')   or define('SERVER_IMPLEMENT_NAME', 'Implement'); //2018-6-1白景琦增加，webservice实现控制器名称后缀
